...
Entity createFish(RenderSystem* renderer, vec2 position)
{
	...
	// add fish to AI
	registry.fishAi.emplace(entity);
	registry.renderRequests.insert(
		entity,
...
// project enemy
Entity creatEnemy(RenderSystem* renderer, vec2 position)
{
	auto entity = Entity();
...
// project block
Entity createBlock(RenderSystem* renderer, vec2 position)
{
	auto entity = Entity();
...
Entity createTurtle(RenderSystem* renderer, vec2 position)
{
	...
	// Create and (empty) Turtle component to be able to refer to all turtles
	registry.hardShells.emplace(entity);
	registry.turtleAi.emplace(entity);
	registry.renderRequests.insert(
		entity,
